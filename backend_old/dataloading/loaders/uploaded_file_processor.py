...
from backend_old.dataloading.loaders.models import Review
from backend_old.dataloading.loaders.text_processor import TextProcessor
from streamlit.runtime.uploaded_file_manager import UploadedFile


class UploadedFileProcessor(TextProcessor):
    def __init__(
            self,
                    ...
                    for sdt in form_fields:
                        ...
                        for p in paragraphs:
                            ...
                            if numPr is not None:
                                ...
                                numbering_prefix = self.get_numbering_prefix(numId, ilvl, numbering_root, level_counters)
