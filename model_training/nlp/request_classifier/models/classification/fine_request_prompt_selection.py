...
few_shot_examples_v2 = {
    ...
    "Request for Clarification": [
        "These numbers correspond to several images, or to a unique image?",
        "Also, how do you select the number of factors of each type?",
        "4. How were the hyperparameters (learning rate, AdaGrad delta, Adam beta1, beta2) chosen?",
...
if __name__ == "__main__":
    ...
    save_directory = os.path.join(script_directory, "fine_request_classifier")
    test_file = os.path.join(script_directory, "dev.csv")
    output_file = os.path.join(script_directory, "evaluation_metrics.txt")
    ...
    for version, few_shot_examples in few_shot_examples_dict.items():
        ...
        accuracy, f1, precision, recall, cm = metrics
